...
<div>
  ...
  <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
    ...
    <el-form-item label="新旧程度">
      <el-select v-model="ruleForm.indentify.oldnew" placeholder="请选择产品新旧程度">
